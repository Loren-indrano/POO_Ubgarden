...
public class ImageResourceFactory {
    ...
    public Image getDigit(int i) {
        ...
        String resourceName = "DIGIT_" + i;
        try {
            ImageResource resource = ImageResource.valueOf(resourceName);
            return get(resource);
        } catch (IllegalArgumentException e) {
            throw new IllegalArgumentException("Invalid image resource: " + resourceName, e);
        }
    }
